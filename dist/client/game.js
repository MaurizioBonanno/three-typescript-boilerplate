...
class Human {
    constructor(scene, pathModel, pathTexture) {
        this.animationActions = new Array();
    ...
    addAnimation(pathAnimation, name) {
        this.fbxLoader.load(pathAnimation, (animation) => {
            let animationAction = this.mixer.clipAction(animation.animations[0]);
...
class OControl extends OrbitControls {
